...
export default function ReportsPage() {
  ...
  const generatePDF = () => {
    ...
    doc.text('Monthly Visit Report', margin, y + 7);
    y += 20;
    ...
    doc.text(`${monthName} ${selectedYear}`, margin, y);
    y += 10;
    ...
    doc.text('Patient', margin + 35, y + 5.5);
    doc.text('Type', margin + 85, y + 5.5);
    doc.text('Organization', margin + 115, y + 5.5);
    ...
    for (const visit of reportData.visits) {
      ...
      const patientName = visit.patient_name?.substring(0, 20) || 'Unknown';
      const visitType = visit.visit_type === 'nurse_visit' ? 'Nurse' : 
                        visit.visit_type === 'vitals_only' ? 'Vitals' : 'Daily Note';
      const org = (visit.organization || '-').substring(0, 15);
